        ...
        <div class="row g-4 align-items-stretch mb-4">
            <div class="col-lg-6">
                ...
                <div class="contact-card p-4 bg-white">
                    ...
                    <p class="text-muted small mb-0"><i class="fa-solid fa-headset text-primary ms-2"></i>برای هماهنگی نوبت و دریافت مشاوره، تنها از طریق تماس تلفنی با ما در ارتباط باشید.</p>
                </div>
            </div>
            <div class="col-lg-6">
