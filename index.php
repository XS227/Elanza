    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="mainNav">
            ...
            <div class="d-flex align-items-center gap-2 ms-lg-3">
                <button class="btn btn-outline-secondary rounded-pill" id="theme-toggle" type="button" aria-pressed="false">
                    <i class="fa-solid fa-moon btn-toggle-icon"></i>
                    <span class="ms-2" id="theme-toggle-label">حالت شب</span>
                </button>
                <a class="btn btn-primary rounded-pill" href="<?= htmlspecialchars($business['bookingUrl'], ENT_QUOTES, 'UTF-8'); ?>" target="_blank" rel="noopener">رزرو آنلاین</a>
            </div>
        </div>
    </div>
</nav>
